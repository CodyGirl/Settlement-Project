...
/**
 * Servlet implementation class BorrowInterest
 */
@WebServlet("/BorrowInterest")
public class BorrowInterest extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public BorrowInterest() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("Borrow Interest");

		// Change the hardcoded value here
		Report report = (new ReportDAOImpl()).getSecurityReportByName("CITI");
