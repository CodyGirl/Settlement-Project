...
import com.generic.DoCorporateAction;
import com.pojos.Equity;
import com.session.SessionDetails;

/**
 * Servlet implementation class ApplyCorporateAction
 */
@WebServlet("/ApplyCorporateAction")
public class ApplyCorporateAction extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ApplyCorporateAction() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		for (Equity equity : eList) {
			...
			jsonFormat = "{\"companyname\": \"" + e.getEquityName() + "\", \"tickersymbol\": \"" + e.getTickerSymbol()
