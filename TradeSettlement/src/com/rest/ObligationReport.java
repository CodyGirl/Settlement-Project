...
/**
 * Servlet implementation class ObligationReport
 */
@WebServlet("/ObligationReport")
public class ObligationReport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("Obligation Report");

		// Change the hardcoded value here
		Report report = (new ReportDAOImpl()).getObligationReportByName("CITI");
